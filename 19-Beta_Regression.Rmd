...
#knitr::include_graphics(c("Figures/Analitica.png", "Graficos/UPR_IPERT_logo.png"))
```
...
dipodium2=dipodium %>% 
  ...
  dplyr::filter(complete.cases(propfr, number_of_flowers,height_inflo, distance))
#dipodium2
...
#knitr::include_graphics(c("Figures/UPR_logos.png"))
```