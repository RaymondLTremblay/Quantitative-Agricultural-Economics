...
Every data analysis project starts with understanding the data. This includes understanding the dimensions of the data, the structure of the data, the levels of the variables, and the relationships between the variables. In this chapter, we will learn how to evaluate the data and understand the data.
...
Another miss coded variable is the variable is the **Julain days**, however, but the information is not the **Julian days** which would be the number of days that have passed since the first day since January 1, 4713 BC. What the authors have in the number of the consecutive days since the 1st January of that year.

 Thus we need to do the follwoing two steps:
...
### First and lat rows few rows of the data
